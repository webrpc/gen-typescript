...
// --
// Code generated by Webrpc-gen@v0.28.2-2-g9506d72 with ../../../gen-typescript generator. DO NOT EDIT.
//
// webrpc-gen -schema=service.ridl -target=../../../gen-typescript -server -out=./server/server.gen.ts -compat
...
const dispatchExampleRequest = async <Context>(service: ExampleServer<Context>, ctx: Context, method: string, payload: any) => {
  switch (method) {
    ...
    case 'GetArticle':
      if (!("getArticleRequest" in payload)) {
        throw new WebrpcBadRequestError({ cause: "missing argument `getArticleRequest`" })
      }
      if ("getArticleRequest" in payload && !validateType(payload["getArticleRequest"], "GetArticleRequest")) {
...
export const WebrpcHeaderValue = "webrpc@v0.28.2-2-g9506d72;gen-typescript@unknown;node-ts@v1.0.0"
