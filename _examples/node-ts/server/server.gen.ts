/* eslint-disable */
// node-ts v1.0.0 b53688815cafa6ec8075a951c87956599920becc
// --
// Code generated by webrpc-gen@v0.13.0 with ../../ generator. DO NOT EDIT.
//
...
export const WebRPCSchemaHash = "b53688815cafa6ec8075a951c87956599920becc"
...
export interface ExampleService {
  ...
  getKinds(headers?: object, signal?: AbortSignal): Promise<GetKindsReturn>
  getKindCount(headers?: object, signal?: AbortSignal): Promise<GetKindCountReturn>
}
...
export interface GetKindsArgs {
}

export interface GetKindsReturn {
  kinds: Array<Kind>  
}
export interface GetKindCountArgs {
}

export interface GetKindCountReturn {
  count: {[key: Kind]: number}  
}
...
import express from 'express'
        ...
        export type ExampleServiceService = {
                ...
                GetKinds: (args: GetKindsArgs) => GetKindsReturn | Promise<GetKindsReturn>
            
                GetKindCount: (args: GetKindCountArgs) => GetKindCountReturn | Promise<GetKindCountReturn>
        ...
        export const createExampleServiceApp = (serviceImplementation: ExampleServiceService) => {
            ...
            app.post('/*', async (req, res) => {
                ...
                switch(requestPath) {
                    ...
                    case "/rpc/ExampleService/GetKinds": {                        
                        try {
                            

                            const response = await serviceImplementation["GetKinds"](req.body);

                            
                                if (!("kinds" in response)) {
                                    throw new WebRPCError("internal", 500);
                                }
                    ...
                    case "/rpc/ExampleService/GetKindCount": {                        
                        try {
                            

                            const response = await serviceImplementation["GetKindCount"](req.body);
