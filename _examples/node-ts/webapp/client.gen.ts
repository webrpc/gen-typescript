...
export interface ExampleService {
  ping(options?: WebrpcOptions): Promise<PingReturn>
  getUser(args: GetUserArgs, options?: WebrpcOptions): Promise<GetUserReturn>
}
...
export class ExampleService implements ExampleService {
  ...
  private url(name: string): string {
    ...
    ping = (options?: WebrpcOptions): Promise<PingReturn> => {
      return this.fetch(this.url('Ping'),createHTTPRequest({}, options)).then((res) => {
    ...
    getUser = (args: GetUserArgs, options?: WebrpcOptions): Promise<GetUserReturn> => {
      return this.fetch(this.url('GetUser'),createHTTPRequest(args, options)).then((res) => {
        return buildResponse(res).then(_data => {
          return {
